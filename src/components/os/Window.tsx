      ...
      >
        <div className="flex items-center gap-2" data-no-drag>
          <button
            ...
            title="Close"
          >
            <Icon name="X" size={8} className="opacity-0 group-hover:opacity-100" color="#5c0500" strokeWidth={3} />
          </button>
          <button
            onClick={() => minimizeWin(win.id)}
            className="group grid h-3 w-3 place-items-center rounded-full bg-[#febc2e]"
            title="Minimize"
          >
            <Icon name="Minus" size={8} className="opacity-0 group-hover:opacity-100" color="#5c3d00" strokeWidth={3} />
          </button>
          <button
            onClick={() =>
              toggleMaximize(win.id, {
            ...
            className="group grid h-3 w-3 place-items-center rounded-full bg-[#28c840]"
            title="Zoom"
          >
            <Icon name="Maximize2" size={7} className="opacity-0 group-hover:opacity-100" color="#0a3d12" strokeWidth={3} />
          </button>
        </div>
        <div className="flex flex-1 items-center justify-center gap-1.5 text-[12px] font-medium text-text1">
